...
//     let cls = `cal-cell heat-${day.heat}`;
//     if (day.status === "today") cls += " status-today";
//     if (day.status === "future") cls += " status-future";
...
//       cell.setAttribute(
//         "data-tooltip",
//         `${day.dateLabel}: ${day.completedCount}/${day.totalHabits}`
//       );
//     }
...
//   const milestones = getStreakMilestones(window.habits || []);
//   const container = document.getElementById("badges-list");
//   container.innerHTML = "";

//   milestones.forEach((m) => {
//     const badge = document.createElement("div");
//     badge.className = `badge-chip ${m.unlocked ? "is-unlocked" : "is-locked"}`;
//     badge.innerHTML = `
//       <span class="badge-icon">${m.unlocked ? m.icon : "🔒"}</span>
//       <span class="badge-label">${m.label}</span>
//       <span class="badge-days">${m.days}d</span>
//     `;
